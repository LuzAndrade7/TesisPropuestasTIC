...
La cadena de conexion actual apunta a Neon con `SSL Mode=Require` y `Channel Binding=Require`.
Para produccion real se recomienda mover credenciales a variables de entorno o secretos, no dejarlas en `appsettings`.
