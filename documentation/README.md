...
La version actual compila en backend y frontend. El build de Angular puede mostrar advertencias de tamano, pero no errores. La conexion a Neon fue validada con Npgsql.
